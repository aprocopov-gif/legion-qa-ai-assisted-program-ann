...
## Task
Create detailed test cases based on these provided acceptance criteria.
## Acceptance Criteria
...
Title: DS-4_Delete program with confirmation
Description: As an admin user, I want to delete a program I no longer need, with a confirmation step to prevent accidental deletion.
